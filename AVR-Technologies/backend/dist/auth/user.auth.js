...
exports.authUserRouter.post("/signup", auth_middleware_1.signupMiddleware, async (req, res) => {
    try {
...
exports.authUserRouter.post("/signin", auth_middleware_1.signinMiddleware, async (req, res) => {
    try {
